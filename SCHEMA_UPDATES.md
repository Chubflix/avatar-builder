...
|--------|------|-------------|---------|
| `generation_type` | `text` | Generation method: `txt2img`, `img2img`, `inpaint`, or `uploaded` | `'txt2img'` |
...
## 2025-11-25
- Expanded allowed values for `images.generation_type` to include `uploaded` to support user-uploaded images that are not generated by the SD pipeline.
